---
name: lets-scroll
description: Build an immersive scroll-scrubbed fly-through landing page with seamless camera flights and AI-generated scenes.
version: 0.8.0
owner: rabto
status: active
categories: ["cinematic-scroll", "creative-web", "video-scroll", "3d-world"]
triggers: ["scroll cinematic", "fly through landing page", "diorama landing", "seamless camera flight", "lets-scroll"]
related_skills: ["cinematic-frame-sequence-scroll", "scroll-video-and-frame-sequences", "single-viewport-scroll-storytelling"]
conflicting_skills: []
