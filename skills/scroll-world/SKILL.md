---
name: scroll-world
description: Build an immersive scroll-scrubbed fly-through landing page with seamless AI camera flights and diorama scenes.
version: 1.0.0
owner: rabto
status: active
categories: ["cinematic-scroll", "creative-web", "video-scroll", "3d-world"]
triggers: ["scroll world", "fly through landing page", "diorama landing", "seamless camera flight", "scroll-world"]
related_skills: ["lets-scroll", "cinematic-frame-sequence-scroll", "scroll-video-and-frame-sequences", "single-viewport-scroll-storytelling", "vanilla-creative-web"]
conflicting_skills: []
primary_tools: ["vanilla-js", "ffmpeg", "monid", "higgsfield"]
minimum_inputs: ["topic or industry", "scene beats"]
